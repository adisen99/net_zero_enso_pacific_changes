...
- file with prefix `01` contains analysis of enso characteristics in CMIP6 multi-model archive;
- files with prefix `02` contains analysis of enso characteristics in ZECIMP and CDRMIP experiments;
- files with prefix `03` contains analysis of enso charactersitics and miscallaneous analysis using ACCESS model transient and net-zero stabilised runs.

Feel free to email me at aditya (dot) sengupta (at) student (dot) unimelb (dot) edu (dot) au in case of queries and requests.
